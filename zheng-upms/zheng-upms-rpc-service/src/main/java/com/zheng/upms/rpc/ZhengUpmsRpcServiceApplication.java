...
//		new ClassPathXmlApplicationContext("classpath:META-INF/spring/applicationContext-dubbo-provider.xml");
//		new ClassPathXmlApplicationContext("classpath:META-INF/spring/applicationContext-ehcache.xml");
	}
